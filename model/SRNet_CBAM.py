...
from model.CBAM_Attention_Module import AttachAttentionModule
...
class Model(nn.Module):
    ...
    def __init__(self) -> None:
        ...
        self.type1s = nn.Sequential(
            Type1(c.stego_img_channel, 64),
            AttachAttentionModule(64),
            Type1(64, 16),
            AttachAttentionModule(16),
        )
...
if __name__ == "__main__":
    image = torch.rand(size=(3, 3, 256, 256))
    net = Model()
    print(net)
